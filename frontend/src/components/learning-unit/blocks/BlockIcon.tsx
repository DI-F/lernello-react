...
import { BookOpen, FileQuestion, CircleHelp, ListChecks, type LucideProps } from 'lucide-react';
...
export const BlockIcon: FC<BlockIconProps> = ({ iconType, className, ...props }) => {
